...
use crate::{Error, ToChrono, ToJiff, TryToJiff};
...
impl TryToJiff<jiff::civil::DateTime> for chrono::NaiveDateTime {
    ...
    fn try_to_jiff(&self) -> Result<jiff::civil::DateTime, Error> {
...
impl ToChrono<chrono::NaiveDateTime> for jiff::civil::DateTime {
    ...
    /// to `chrono::NaiveDate` and from `jiff::civil::Time` to `chrono::NaiveTime` are both
    /// infallible.
